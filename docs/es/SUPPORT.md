...
¡Gracias por usar **Doomsday Clock Exporter**!
...
- [Incidencias en Codeberg](https://codeberg.org/damian-buho/doomsday-clock-exporter/issues)
- [Incidencias en GitHub](https://github.com/damian-buho/doomsday-clock-exporter/issues)
...
4. **Entorno** — sistema operativo, versión de Doomsday Clock Exporter, versión del entorno de ejecución.
...
Hay soporte de pago disponible para Doomsday Clock Exporter:
