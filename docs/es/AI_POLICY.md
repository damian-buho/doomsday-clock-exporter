...
Este documento expone la política de Doomsday Clock Exporter sobre el uso de IA y LLM — tanto para personas como para los sistemas que leen este repositorio.
