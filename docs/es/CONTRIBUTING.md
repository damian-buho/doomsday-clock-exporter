...
# Cómo contribuir a Doomsday Clock Exporter
...
>
> - Dale una estrella al proyecto en [codeberg.org](https://codeberg.org/damian-buho/doomsday-clock-exporter)
> - Dale una estrella al proyecto en [github.com](https://github.com/damian-buho/doomsday-clock-exporter)
...
- Para ver si otras personas han tenido (y quizá ya resuelto) el mismo problema, comprueba que no exista ya un informe de tu fallo o error en el [gestor de incidencias](https://github.com/damian-buho/doomsday-clock-exporter/issues?q=label%3Abug).
...
Usamos [Issues de GitHub](https://github.com/damian-buho/doomsday-clock-exporter/issues) para seguir fallos y errores. Si te topas con un problema en el proyecto:

- Abre una [incidencia](https://github.com/damian-buho/doomsday-clock-exporter/issues/new). (Como todavía no podemos saber si se trata de un fallo, te pedimos que no lo des por hecho ni etiquetes la incidencia.)
...
Esta sección te guía para enviar una propuesta de mejora para Doomsday Clock Exporter, **tanto funcionalidades completamente nuevas como pequeñas mejoras de lo existente**. Seguir estas indicaciones ayudará a quienes mantienen el proyecto y a la comunidad a entender tu propuesta y a encontrar sugerencias relacionadas.
...
- Haz una [búsqueda](https://github.com/damian-buho/doomsday-clock-exporter/issues) para ver si ya se ha propuesto. Si es así, comenta en la incidencia existente en lugar de abrir una nueva.
...
- **Explica por qué esta mejora sería útil** para quienes usan Doomsday Clock Exporter. También puedes señalar otros proyectos que lo hayan resuelto mejor y que sirvan de inspiración.
